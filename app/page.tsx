  ...
  <Link href="/e-paper" className="block">
    <div className="bg-gradient-to-r from-orange-500 to-orange-600 text-white py-10 px-6 text-center mb-6 cursor-pointer">
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-center items-center mb-2">
          <Newspaper className="h-8 w-8 mr-2" />
          <h1 className="text-3xl md:text-4xl font-bold">Our E-Paper</h1>
        </div>
