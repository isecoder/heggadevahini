...
const Latest = () => {
    ...
    const fetchLatestNews = async () => {
      try {
        ...
        if (data.success && data.data.length > 0) {
          // Filter news containing the "Latest" tag
          const latestNews = data.data
            ...
            .slice(0, 3); // Get the latest 3 news articles
  ...
  if (newsList.length === 0) return <p>No latest news available.</p>;
  ...
  return (
    <section className="bg-[#FFF3E9] p-4 rounded-lg">
      <div className="relative group">
        ...
        {/* Tags (Filtered to Only Show "Latest") */}
